...
class ParcelsController < ApplicationController
  ...
  before_action :set_user_and_service_types, only: %i[new edit create]
  ...
  # Set the @users and @service_types variables
  def set_user_and_service_types
